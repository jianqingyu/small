...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    self.titleLabel.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.4];
...
//    _pageControl.currentPageIndicatorTintColor = MAIN_COLOR;
      [_pageControl setValue:[UIImage imageNamed:@"banner_s"] forKeyPath:@"pageImage"];
      [_pageControl setValue:[UIImage imageNamed:@"banner_m"] forKeyPath:@"currentPageImage"];
